            ...
            {fechaSel && (
              <>
                ...
                {cargando ? (
                  ...
                  <div className="text-center p-4 rounded-xl" style={{ background: "#fff0f5", border: "1px dashed #f0d080" }}>
                    <p className="text-2xl mb-2">🌸</p>
                    <p className="font-semibold text-sm" style={{ color: "#c9a84c" }}>Los domingos no atendemos</p>
        ...
        {paso === "datos" && servicioSel && (
          <div>
            ...
            <div className="mt-6 p-4 rounded-xl" style={{ background: "#fff0f5", border: "1px solid #f0d080" }}>
              <p className="text-sm font-semibold mb-1" style={{ color: "#c9a84c" }}>Anticipo requerido</p>
    ...
    <main className="min-h-screen py-8 px-4" style={{ background: "linear-gradient(180deg, #fff0f5 0%, #fff8f0 100%)" }}>
      <div className="max-w-xl mx-auto text-center">
        ...
        <div className="card-elegant p-6 text-left mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between text-base font-bold">
              <span style={{ color: "#c9a84c" }}>Anticipo a pagar:</span>
        ...
        <div className="card-elegant p-5 text-left mb-4">
          <p className="font-semibold mb-4 text-center" style={{ color: "#c9a84c" }}>📋 ¿Qué debes hacer ahora?</p>
          <div className="space-y-4">
            <div className="flex gap-3 items-start">
              <div className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold text-white"
                style={{ background: "linear-gradient(135deg,#c9a84c,#f0d080)" }}>1</div>
              <div>
                <p className="font-semibold text-sm">Realiza el pago del anticipo</p>
                <p className="text-xs mt-0.5" style={{ color: "#888" }}>Paga <strong>{formatPrecio(anticipo)}</strong> por Nequi o Bancolombia al número <strong>3234661252</strong>. Tienes <strong>30 minutos</strong>.</p>
              </div>
            </div>
            <div className="flex gap-3 items-start">
              <div className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold text-white"
                style={{ background: "linear-gradient(135deg,#c9a84c,#f0d080)" }}>2</div>
              <div>
            ...
            <div className="flex gap-3 items-start">
              <div className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold text-white"
                style={{ background: "linear-gradient(135deg,#c9a84c,#f0d080)" }}>3</div>
              <div>
        ...
        {/* Botón WhatsApp */}
        <a
          href={`https://wa.me/573234661252?text=${encodeURIComponent(`Hola Leila Studio 👋 Acabo de reservar una cita.\n\n📋 *Reserva:* ${servicio.nombre}\n📅 *Fecha:* ${fecha} a las ${hora}\n👤 *Nombre:* ${nombre}\n\nTe envío el comprobante del anticipo de ${formatPrecio(anticipo)} 👇`)}`}
          target="_blank"
